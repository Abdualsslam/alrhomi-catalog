...
interface ImageDistributionData {
  name: string;
  value: number;
}

interface ImagesDistributionCardProps {
  data: ImageDistributionData[];
}

export default function ImagesDistributionCard({ data }: ImagesDistributionCardProps) {
          ...
          {data.map((item, idx) => (
            <Box
              ...
              sx={{
                ...
                bgcolor:
                  theme.palette.mode === "dark"
                    ? alpha(getColor(idx), 0.1)
                    : alpha(getColor(idx), 0.08),
              }}
            >
              <Box
                sx={{
                  ...
                  borderRadius: "50%",
                  boxShadow: `0 2px 8px ${alpha(getColor(idx), 0.4)}`,
                }}
              />
              <Typography
                variant="body2"
